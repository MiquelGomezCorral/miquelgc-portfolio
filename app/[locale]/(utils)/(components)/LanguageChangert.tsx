...
export default function LanguageChanger() {
  ...
  return (
    <div ref={dropdownRef} className="relative inline-block ">
      ...
      {open && (
        <div className="absolute mt-2 bg-miquel-background shadow-md z-10 w-full border border-b-2 border-b-miquel-white-200/50 border-t-0 rounded-md rounder-t rounded-t-none">
          {languages.map(lang => (
            <div
              key={lang.locale}
              onClick={() => handleChange(lang.locale)}
              className="flex items-center cursor-pointer px-4 py-2 gap-2 hover:bg-miquel-black-100 w-full"
            >
