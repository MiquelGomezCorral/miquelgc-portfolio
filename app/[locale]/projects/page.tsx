...
export default async function ProjectsPage({ params }: { params: any }) {
  ...
  return (
    ...
    >
      ...
      <main className="max-w-[110rem] w-full flex flex-col gap-x-16 px-4 md:px-10 xl:px-48 2xl:px-64">
        <section className="w-full h-full flex flex-col gap-x-6 bg-miquel-background text-white ">
